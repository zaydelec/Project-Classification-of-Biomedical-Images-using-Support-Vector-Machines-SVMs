...
mat2libsvm(feattrain2,labtrain, 'train.libsvm') 
...
% % % % 
% % % % roiMaskVector = imageData.roiMask(:);
% % % % originalImVect=[]
% % % % 
% % % % RedVect= imageData.originalImage(:,:,1);
% % % % Red=RedVect(:);
% % % % GreenVect=imageData.originalImage(:,:,2);
% % % % Green=GreenVect(:);
% % % % BlueVect=imageData.originalImage(:,:,3);
% % % % Blue=BlueVect(:);
% % % % 
% % % % originalImVect = [ roiMaskVector, Red,Green,Blue];
% % % % %scatter3(RedVect,GreenVect,BlueVect)
% % % % [n,m] =size(imageData.roiMask);
% % % % R=rand(n*m,1);
% % % % plot(R)
%IDX = kmeans(originalImVect,4);
%trainAll[]
%[trainsmall]=RandomSampling(trainAll)


% d=data(originalImVect, roiMaskVector)
% [tr a]=train(svm,d)
% 
